...
void rgb_ctl_init(void)
{
	...
	LL_TIM_OC_SetCompareCH1(RGB_CTL_TIMER, RGB_CTL_TIMER->ARR + 1);
	LL_TIM_OC_SetCompareCH2(RGB_CTL_TIMER, RGB_CTL_TIMER->ARR + 1);
	LL_TIM_OC_SetCompareCH4(RGB_CTL_TIMER, RGB_CTL_TIMER->ARR + 1);
}
